        ...
        <div class="container-fluid text-center">
            <div class="row-content">
                ...
                <div class="col-sm-8 text-left"> 
                    <form action="PristupiIzmenama" method="post">
                        <div class="col-xs-4">
                            <label for="id">ID: </label>
                            <input type="text" name="idVesti" class="form-control" id="id" value="${izabranaVest.id_vesti}" readonly="true">
                            
                            <label for="naslov">Naslov vesti:</label>
                            <input type="text" class="form-control" id="naslov" name="novNaslovi" value="${izabranaVest.naslov}">

                            <label for="sadrzajVesti">Sadrzaj vesti:</label>
                            <textarea class="form-control" cols="40" rows="5" id="sadrzajVesti" name="novSadrzaj">${izabranaVest.sadrzaj}</textarea><br/>

                            <button type="submit" class="btn">Izmeni vest</button><br/>
                        </div>
                    </form>
                </div>
                <div class="col-sm-2 sidenav">
