...
<html>
    <head>
        ...
        <title>Azuriranje dogadjaja</title>
            ...
            <div class="row-content">
                ...
                <div class="col-sm-8 text-left"> 
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${listaDogadjaja}" var="dogadjaj">
                            <tr>
                                <td>${dogadjaj.naslov}</td>
                                <td>${dogadjaj.sadrzaj}</td>
                                <td>${dogadjaj.datumPostavljanja}</td>
                                <td>${dogadjaj.slika}</td>
                                <td>${dogadjaj.datumOdrzavanja}</td>
                                <td>${dogadjaj.mesto}</td>    
                                <td><a href="IzmeniDogadjaj?id=${dogadjaj.id_dogadjaja}">Izmeni</a></td>
                                <td><a href="ObrisiDogadjaj?id=${dogadjaj.id_dogadjaja}">Obrisi</a></td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
